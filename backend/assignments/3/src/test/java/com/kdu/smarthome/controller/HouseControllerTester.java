...
public class HouseControllerTester {
        ...
        try {
            ...
            mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/house")
                    ...
                    .andDo(result -> {
                        ...
                        String houseId = JsonPath.read(response, "$.house.id").toString();
    ...
    public static void addUserToHouseByNonAdmin(MockMvc mockMvc, String... args) throws Exception {
        try {
            ...
            AuthControllerTester.registerUser(mockMvc, firstName, lastName, username, password, email);
