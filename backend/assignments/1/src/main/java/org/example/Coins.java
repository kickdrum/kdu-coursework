...
//        c.add(String.valueOf());
        c.add(String.valueOf(index)); //,Rank,Name,Symbol,Price,Circulating Supply
        c.add(String.valueOf(name));
        c.add(String.valueOf(symbol));
        c.add(String.valueOf(price));
        c.add(String.valueOf(circulatingSupply));
