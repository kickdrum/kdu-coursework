...
@Service
public class VehicleServiceFactory1 {
    ...
    @Autowired
    public VehicleServiceFactory1(@Qualifier("factory1") InventoryStore invStore){
    ...
    public void getMinimumPriceVehicle() {
        ArrayList<Vehicle> vehicles = invStore.getVehicles();
        System.out.println("Least Expensive Vehicle for factory 1 Details:");
